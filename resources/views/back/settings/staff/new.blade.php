...
@section('form-actions')
    <a class="btn-c" href='/admin/settings/staff'>Discard</a>
        ...
        <div class="page-content new-entry">
            <div class="page-head">
                ...
                <div class="page-title">
                    <a class="page-action-back" href="/admin/settings/staff"><i class="fa fa-angle-left"></i> Staff</a>
                    <h1>Add User</h1>
                </div>
                <!-- END PAGE TITLE -->
            </div>
            <!-- BEGIN PAGE BASE CONTENT -->
            <form class="form-horizontal" id="newEntry" method="POST" action="/admin/settings/staff/new" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-8">
