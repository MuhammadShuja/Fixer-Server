        ...
        <div class="page-content new-entry">
            <div class="page-head">
                ...
                <div class="page-title">
                    <a class="page-action-back" href="/admin/settings/staff"><i class="fa fa-angle-left"></i> Users</a> <h1>User Overview</h1>
                    <a class="page-action-new" href="/admin/settings/staff/new"><i class="fa fa-plus"></i> Add New</a>
                </div>
                <!-- END PAGE TITLE -->
            </div>
            @if($alert == 'add')
            ...
            <form class="form-horizontal" id="newEntry" method="POST" action="/admin/settings/staff/{{$user->id}}" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-8">
           ...
           swal({
            ...
            function(isConfirm){
                if (isConfirm) {
                    $.ajax({
                      type: "POST",
                      url: "/admin/settings/staff/remove",
                      data: {
                      ...
                      success: function(data){
                        ...
                        window.location.href=base_url+'/admin/settings/staff';
                      },
                      error: function(data){
