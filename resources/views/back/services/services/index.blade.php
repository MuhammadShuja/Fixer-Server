@extends('back.master')
@section('title')
    <title>Services ~ {{ config('app.sys') }}</title>
@endsection
@section('meta')
        ...
        <div class="page-content">
            <div class="page-head">
                ...
                <div class="page-toolbar">
                    <a class="btn-c btn-p" href='/admin/s/services/new'>Add service</a>
                </div>
            </div>            
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="dtSearch" placeholder="Search services">
    ...
    <script>
        window.onload = function(){
            $(document).ready(function() {
                ...
                $('#indexTable').on('click', 'tbody td', function(){
                   window.open('{{config('APP_URL')}}/admin/s/services/'+$(this).closest('tr').find('td:eq(0)').data('link'));
                });
        ...
        function populateData(key){
            var dt = $('#indexTable').on('error.dt', function (e, settings, techNote, message) {
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": "/api/admin/s/services?status="+key,
                    "autoWidth":false,
                    fixedHeader: {
                        header: true,
            ...
            var export_filename = '~ {{ config('app.sys') }}_Services';
